...
The SDTH vocabulary is a set of URIs, given in the left-hand column in Tables 1 and 2. The right hand column indicates which section of this document explains the corresponding term in more detail.
...
<td>sdth:Program, sdth:ProgramStep</td>
<td>xsd:string</td>
<td></td>
</tr>
<tr>
...
ProvONE [[ProvONE]] is an extension of PROV designed to describe scientific workflow computational processes.
