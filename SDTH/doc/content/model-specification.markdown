...
**is in domain of**
- sdth:hasProgramStep, sdth:loadsFile, sdth:savesFile, sdth:producesData, sdth:consumesData, sdth:hasVarInstance, dth:usesVariable, sdth:assignsVariable
...
**is in range of**
- sdth:producesData, sdth:consumesData, sdth:wasDerivedFrom, sdth:elaborationOf
...
###  sdth:TextInstance {#model-texinstance} 
